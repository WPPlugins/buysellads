...
class BSA_Plugin 
{
  ...
  function bsa_admin() 
  {
    if (current_user_can('activate_plugins'))
    {
      ...
      // Create Menu Items
      add_menu_page( $plugin_title, $plugin_title, 'upload_files', 'bsa_settings', array( $this, 'bsa_admin_settings' ), $icon );
  ...
  function bsa_admin_settings()
  {
    ...
    if( isset($_POST[ 'option_values' ]) && $_POST[ 'option_values' ] == 'save' ) 
    {
      ...
      $bsa_rss_zone_top = !empty($_POST['bsa_rss_zone_top']);
      ...
      $bsa_mobile_zone_bottom = !empty($_POST['bsa_mobile_zone_bottom']);
