...
class BSA_Widget extends WP_Widget 
{
  ...
  function __construct()
  {
    ...
    $widgetDescription = $bsa_lang instanceof \BSA_Language ? $bsa_lang->line('widget_description') : "This official BuySellAds.com WordPress plugin gives you simple ways to insert your BSA ad code, including BSA Widgets and RSS/mobile advertisements.";
    $pluginTitle       = $bsa_lang instanceof \BSA_Language ? $bsa_lang->line('plugin_title') : "BuySellAds";

    $widget_ops = array('classname' => 'widget_bsa', 'description' => $widgetDescription );
    parent::__construct('bsa', $pluginTitle, $widget_ops);
  }
